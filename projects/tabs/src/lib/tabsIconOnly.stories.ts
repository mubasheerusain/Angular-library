...
export const PrimaryExtraLargeIconOnly = TabStory.bind({});

PrimaryExtraLargeIconOnly.args = {
  variant: 'primary',
  size: 'extraLarge'
};

export const PrimaryLargeIconOnly = TabStory.bind({});

PrimaryLargeIconOnly.args = {
  variant: 'primary',
  size: 'large'
};

export const TextExtraLargeIconOnly = TabStory.bind({});

TextExtraLargeIconOnly.args = {
  variant: 'basic',
  size: 'extraLarge'
};

export const TextLargeIconOnly = TabStory.bind({});

TextLargeIconOnly.args = {
  variant: 'basic',
  size: 'large'
};